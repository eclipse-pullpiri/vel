# VEL Coding Specification

**Author**: Daeyoung Jeong (@daeyoung-jeong-lge)

VEL is developed using the Rust programming language. For language semantics and Rust usage, developers shall refer to and follow the publicly available standard Rust documentation.
